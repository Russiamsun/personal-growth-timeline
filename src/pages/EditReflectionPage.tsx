...
import { ArrowLeft, CheckCircle, AlertCircle, Calendar, Tag, BookOpen, Feather } from 'lucide-react';
...
export default function EditReflectionPage() {
  ...
  const { reflections, updateReflection } = useData();
  ...
  useEffect(() => {
    if (reflection) {
      setFormData({
        contentZh: reflection.contentZh || '',
        contentEn: reflection.contentEn || '',
        date: reflection.date,
        tagsZh: (reflection.tagsZh || []).join(','),
        tagsEn: (reflection.tagsEn || []).join(','),
      });
      setIsLoading(false);
    } else {
      setIsLoading(false);
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        ...
        >
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg hover:shadow-lg transition-all"
          >
            {t.form.back}
          </button>
        </motion.div>
      ...
      >
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">{t.form.editReflection}</h1>
          </div>
