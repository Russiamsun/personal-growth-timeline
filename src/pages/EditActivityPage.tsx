...
export default function EditActivityPage() {
  ...
  useEffect(() => {
    if (activity) {
      setFormData({
        ...
        contentZh: activity.contentZh || '',
        contentEn: activity.contentEn || '',
        date: activity.date,
        locationZh: activity.locationZh || '',
  ...
  if (!activity) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-orange-50 via-yellow-50 to-amber-50">
        <motion.div
          className="text-center"
      ...
      >
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">{t.form.editActivity}</h1>
          </div>
